      ...
      <div class="ctrl-bar">
        ...
        <div class="right-group">
          ...
          <div class="tooltip-wrap">
            ...
            <div class="tooltip">单曲循环：{{ repeatMode ? '开' : '关' }}</div>
          </div>
...
<style>
:root{
 --bg-gradient: linear-gradient(135deg,#1a1a1e 0%,#0d0d0f 100%);
 --glass-main: rgba(255,255,255,0.04);
 --glass-item: rgba(255,255,255,0.07);
...
.modal-close:hover { background: rgba(255,255,255,0.08); color: #ccc; }
...
.new-input:focus { border-color: rgba(255,255,255,0.25); }
.new-btn {
 padding: 8px 16px;
